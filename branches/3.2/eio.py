...
interface('eio_read'  , eio_req_p, c_int, c_void_p, c_size_t, c_off_t, c_int,
    eio_cb, c_void_p)
interface('eio_write' , eio_req_p, c_int, c_void_p, c_size_t, c_off_t, c_int,
    eio_cb, c_void_p)
interface('eio_mkdir' , eio_req_p, c_char_p, c_mode_t, c_int,
    eio_cb, c_void_p)
